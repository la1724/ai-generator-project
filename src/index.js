...
function generateQuote(event) {
  ...
  let context =
    " Your mission is to generate minimum of 1 line and maximum of 4 line quote  and separate each line with a <br />. Make sure to follow the user instructions.  Provide an author of the quote inside a <strong> element at the end of the quote and NOT at the beginning";
